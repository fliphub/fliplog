...
var requirePkg = require('../')
var createCharm = requirePkg('charm')
var inherits = requirePkg('inherits')
var duplexer = requirePkg('duplexer2')
var visualwidth = requirePkg('./visualwidth')
...
Menu.prototype._ondata = function ondata(buf) {
  ...
  while (bytes.length) {
    ...
    if (/^(27.91.65|27,79.65|107|16)\b/.test(codes)) {
      // up or k
      this.selected =
    ...
    if (/^(27.91.66|27.79.66|106|14)\b/.test(codes)) {
      // down or j
